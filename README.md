...
- Para rodar o jogo basta abrir o código das classes grafo.py e jogo_visual.py, juntamente com as imagens salvas na pasta do projeto, juntamente com a importação da biblioteca Pygame.
...
- Os agentes são adicionados na inicialização do jogo na área destinada a eles, na parte inferior do tabuleiro do jogo. Essa adição ocorre de forma aleatória, considerando um número consideravelmente grande de possíveis agentes, minimizando os espaços vazios;
